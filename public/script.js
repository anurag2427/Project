function aboutUs()
{
    ...
    document.getElementById('b').innerHTML='<div class="footer"><div class="container"><center><p>&copy;ANURAG , KARTIK MEHMI , JATINDER KUMAR</p></center></div></div>';
}